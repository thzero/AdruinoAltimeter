...
// byte CommunicationQueue::setup(CommunicationRadio* radio) {
//     if (radio == nullptr)
//         return 1;
...
// void CommunicationQueue::initCommand(uint16_t command, CommunicationCommandFunctionPtr func) {
...
// int CommunicationQueue::process(unsigned long timestamp, unsigned long delta) {
// #if defined(TEENSYDUINO)
...
//   _radio.write(message.buffer, message.size);
...
// int CommunicationQueue::queue(uint16_t command) {
...
// int CommunicationQueue::queue(uint16_t command, uint8_t *byteArray, size_t size) {
...
// size_t CommunicationQueue::read(CommunicationHandlerFunctionPtr func, unsigned long timestamp, unsigned long delta) {
//     return 0;
...
// void CommunicationQueue::write(uint8_t* byteArray, size_t length) {
// }